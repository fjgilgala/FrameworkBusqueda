 ...
 * media geometrica de los tiempos de procesamiento entre las tareas no
 * planificadas.
 * 
 ...
 * 
 */
public class Hedd_promedio_G extends HeuristicoPlanificacionTareas {

	@Override
	protected int valorHeuristico(EstadoAsignacionTrabajosMaquina estado) {
		return new EDD_all(estado,
				calculaValorPromediante(mediaGeometrica(estado.getSin_asignar()), estado.getSin_asignar())).g();
