 ...
 * mediana de los tiempos de procesamiento entre las tareas no planificadas.
 * 
 ...
 * 
 */
public class Hedd_promedio_M extends HeuristicoPlanificacionTareas {

	@Override
	protected int valorHeuristico(EstadoAsignacionTrabajosMaquina estado) {
		return new EDD_all(estado, calculaValorPromediante(mediana(estado.getSin_asignar()), estado.getSin_asignar()))
				.g();
	}
}